...
export default function Bedroom() {
  ...
  // Load liked designs for this user
  useEffect(() => {
    if (!userId) return;
  ...
  return (
    <>
      ...
      <section className="py-24 text-center bg-[#FAF8F5]">
        <h2 className="font-serif text-5xl mb-4">Bedroom Designs</h2>
        <p className="text-muted">
          Explore cozy, stylish, and modern bedroom interiors
        </p>
      </section>
