...
export default function Bathroom() {
  ...
  // Load liked designs only if user exists
  useEffect(() => {
    if (!userId) return;
  ...
  return (
    <>
      ...
      <section className="py-24 text-center bg-[#FAF8F5]">
        <h2 className="font-serif text-5xl mb-4">Bathroom Designs</h2>
        <p className="text-muted">Explore premium, stylish and functional bathrooms</p>
      </section>
